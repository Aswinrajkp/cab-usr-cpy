...
class AfterConfirmScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<VehicleDetailsServices>(builder: (vehicleController) {
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return ListTile(
              onTap: () async {
                String vehicleId =
                    await availableVehicles.gettingAvailableVehilces(
                        vehicle["vehicle_name"],
                        );
                      payment.payment= (vehicle["charge"] * dis).toStringAsFixed(2);
                Navigator.push(
                  context,
                  MaterialPageRoute(
